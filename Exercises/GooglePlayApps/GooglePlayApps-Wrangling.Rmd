...
apps_versions_dataset <- apps_versions_dataset %>% 
  ...
  mutate(Current.Ver = case_when(
           str_detect(Current.Ver,",") ~ str_replace_all(Current.Ver.Original,",","."),
           Current.Ver != varies &  str_detect(Current.Ver.Original,"-[a-zA-Z\\s]$") ~ str_remove_all(Current.Ver.Original,"-[a-zA-Z\\s]$"),
           Current.Ver != varies &  str_detect(Current.Ver.Original,"[a-zA-Z]") ~ str_remove_all(Current.Ver.Original,"[a-zA-Z]"),
           Current.Ver != varies & str_detect(Current.Ver.Original, "[(*)]") ~ str_remove_all(Current.Ver.Original,"[(*)]"),
           Current.Ver != varies & str_detect(Current.Ver.Original, "-[0-9]*") ~ str_remove_all(Current.Ver.Original,"-[0-9]*$"),
